    ...
    return (
        <div className='px-8 py-4'>
            ...
            <div className='hidden lg:block'>
                <div className='flex gap-6 items-start justify-start overflow-x-auto whitespace-nowrap scrollbar-hidden'>
            ...
            {isModalOpen && modalData && (
              <div
                ...
                <div
                    ...
                    className="bg-[#1E1E1F] p-6 rounded-xl max-w-md md:max-w-lg lg:max-w-2xl w-full relative text-white max-h-[90vh] overflow-y-auto">
                  <button
